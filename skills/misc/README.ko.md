...
이 스킬은 **Available**(실사용 검증 완료)이며 [mattpocock/skills](https://github.com/mattpocock/skills) 에서 가져왔다. [THIRD_PARTY_NOTICES.md](../../THIRD_PARTY_NOTICES.md) 참고. 런타임 전용 설정 스킬은 [`runtimes/`](../../runtimes)에 둔다.
